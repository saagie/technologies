...
exports.start = async ({ job, instance }) => {
  try {
    ...
    const jobToCreate =  {
      ...
      notebook_task: {
        base_parameters: [],
        notebook_path: job.featuresValues.notebook.label
      }
    };

    if (job.featuresValues.jobParameters) {
      const jobParameters = JSON.parse(job.featuresValues.jobParameters);
      jobToCreate.notebook_task.base_parameters = jobParameters;
    }
