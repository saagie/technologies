...
exports.start = async ({ job, instance }) => {
  try {
    ...
    const res = await axios.post(
      `${AZURE_MANAGEMENT_API_URL}${job.featuresValues.resourceGroup.id}/providers/Microsoft.DataFactory/factories/${job.featuresValues.factory.label}/pipelines/${job.featuresValues.pipeline.label}/createRun?referencePipelineRunId=${job.featuresValues.pipelineRun.id}&isRecovery=true&api-version=2018-06-01`,
      {},
