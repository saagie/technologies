> [!NOTE] 
> This Docker image is designed to run on Saagie’s V2 platform. It is available on <a href="https://hub.docker.com/r/saagie/orientdb" target="_blank">Saagie’s DockerHub</a> and is based on the official OpenJDK Docker image, <a href="https://hub.docker.com/_/openjdk" target="_blank">openjdk:8-jre-slim</a>.
