...
create TABLE IF NOT EXISTS supervision_saagie_jobs
  (
     ...
     isScheduled            BOOLEAN,
     cronScheduling         VARCHAR(60),
     scheduleTimezone       VARCHAR(60),
...
create TABLE IF NOT EXISTS supervision_saagie_pipelines
  (
     project_id             VARCHAR(60),
     project_name           VARCHAR(250),
     creation_date          TIMESTAMP,
...
create TABLE IF NOT EXISTS supervision_saagie_predict
  (
     project_id             VARCHAR(60),
     project_name           VARCHAR(250),
     orchestration_type     VARCHAR(10),
     orchestration_name     VARCHAR(250),
     next_orchestration_id  INT,
     next_instance_start    TIMESTAMP,
     next_instance_end      TIMESTAMP,
     avg_instance_duration  INT
  );
