...
class SupersetAppInitializer:  # pylint: disable=too-many-public-methods
    ...
    def init_views(self) -> None:
        ...
        appbuilder.add_view(
            DashboardModelView,
            "Dashboards",
            label=__("Dashboards"), href="/nimp/dashboard/list/",
            icon="fa-dashboard",
            category="",
            category_icon="",
        )
        appbuilder.add_view(
            SliceModelView,
            "Charts",
            label=__("Charts"), href="/nimp/chart/list/",
            icon="fa-bar-chart",
            category="",
            category_icon="",
        )
        ...
        appbuilder.add_view(
            DynamicPluginsView,
            "Plugins",
            label=__("Plugins"), href="/nimp/dynamic-plugins/list/",
            category="Manage",
        ...
        appbuilder.add_view(
            CssTemplateModelView,
            "CSS Templates",
            label=__("CSS Templates"), href="/nimp/csstemplatemodelview/list/",
            icon="fa-css3",
            category="Manage",
            category_label=__("Manage"),
            category_icon="",
        ...
        appbuilder.add_link(
            ...
            href="/nimp/superset/import_dashboards/",
        ...
        appbuilder.add_link(
            ...
            href="/nimp/superset/sqllab/history/",
            icon="fa-search",
            category_icon="fa-flask",
            category="SQL Lab",
        ...
        appbuilder.add_view(
            LogModelView,
            "Action Log",
            label=__("Action Log"), href="/nimp/logmodelview/list/",
            category="Security",
        ...
        appbuilder.add_view(
            AnnotationLayerView,
            "Annotation Layers",
            label=__("Annotation Layers"), href="/nimp/annotationlayermodelview/list/",
...
class SupersetIndexView(IndexView):
    ...
    def index(self) -> FlaskResponse:
        return redirect("/nimp/superset/welcome/")
