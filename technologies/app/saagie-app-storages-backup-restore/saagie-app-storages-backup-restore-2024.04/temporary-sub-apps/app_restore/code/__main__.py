...
def main():
    ...
    # Get env vars
    storage_folder = os.environ["RESTORE_STORAGE_FOLDER"]  # Path directory on image, e.g. /notebooks-dir
    s3_bucket_name = os.environ["BACKUP_S3_BUCKET_NAME"]  # Bucket name on S3, e.g. saagie-backup
    s3_prefix = os.environ["RESTORE_S3_PREFIX"]  # Prefix of the file, e.g. id-projet/id-app/date
    project_id = os.environ["BACKUP_APP_PROJECT_ID"]  # Project ID of this app
    app_prefix = os.environ["RESTORE_TMP_APP_PREFIX"]  # Prefix of this app name
